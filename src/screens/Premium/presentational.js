      ...
      return (
        <Fragment>
          <Animatable.View cls="flx-i" animation="fadeInUp">
            <View cls="pt3 ph2">
              <ScrollView>
                <Title theme={theme} align="center">
                  {t("screens.premium.title", translation)}
                </Title>
              </ScrollView>
              <View cls="ph2">
                <Button
            ...
            <View cls="flx-i">
              <Body theme={theme}>
                <View cls="ph2">
                  <Text cls={`f5 fw9 tac ${globalThemedStylesheet.text.color[theme]}`}>
                    {t("screens.premium.advantages", translation)}
                  </Text>
                  {sections.map((section, key) => (
                    <Fragment key={key}>
                      <Title margin="mt3 mb2" theme={theme} align="center">
                        {t(`screens.premium.sections.${section}.title`, translation)}
                      </Title>
                      <Text cls={`mb3 tac ${globalThemedStylesheet.text.color[theme]}`}>
                        {t(`screens.premium.sections.${section}.text`, translation)}
                      </Text>
                    </Fragment>
                  ))}
                </View>
