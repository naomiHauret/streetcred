...
export const accessToken =
  "MC5YRkx3bmhNQUFDVUFPQlk3.QEAGIO-_vW0E77-9VTQMHO-_vTHvv71277-977-977-9Qe-_vVLvv73vv700ee-_vUXvv73vv73vv73vv70"
...
export const estimateReadingTime = (text) => {
  const textWithoutMarkup = text.replace(/<[^>]*>/g, "") // remove all html tags
