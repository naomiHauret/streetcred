        ...
        return (
          <Fragment>
            <Body theme={theme}>
              ...
              {this.props.isFocused && (
                <Animatable.View animation="fadeInUp" delay={150} duration={250}>
                  {sections.map((section, key) => (
                    <View key={key}>
                      <Title theme={theme} align="left" margin="mb3">
                        {t(`screens.about.${section}.title`, translation)}
                      </Title>
                      <Paragraph
                        additionalStyles={`${globalThemedStylesheet.text.color[theme]} ${
                          section === "premium" ? "" : "mb4"
                        }`}
                      >
                        {t(`screens.about.${section}.text`, translation, {
                          price: PREMIUM_PRICE,
                          number: DAILY_ARTICLES_NUMBER,
                        })}
                      </Paragraph>
                      {section === "premium" && (
                        <Button
